...
const addCorsHeaders = (res) => {
  res.headers.set('Access-Control-Allow-Origin', 'https://customizable-dashboard-nextjs-e35zt3r5z-jithin7777s-projects.vercel.app'); // Replace with your frontend URL
